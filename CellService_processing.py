...
class Processing_cellService(QMainWindow):
    ...
    def maximize_set_segmentation(self):
        ...
        self.remove_title.setGeometry(QtCore.QRect(screen_height*1.3*0.071, screen_height*1.3*0.10, screen_height*1.3*0.124, screen_height*1.3*0.0177))
        ...
        self.open_title.setGeometry(QtCore.QRect(screen_height*1.3*0.0796, screen_height*1.3*0.29, screen_height*1.3*0.081, screen_height*1.3*0.0186))
        self.close_title.setGeometry(QtCore.QRect(screen_height*1.3*0.0796, screen_height*1.3*0.35, screen_height*1.3*0.081, screen_height*1.3*0.0186))
